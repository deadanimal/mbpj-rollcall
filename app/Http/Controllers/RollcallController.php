...
class RollcallController extends Controller
{
    ...
    public function edit(Rollcall $rollcall)
    {
        ...
        $userrollcalls = Userrollcall::with(['pegawaiSokong', 'pegawaiLulus'])->where('roll_id', '=', $rollcall->id)->get();
    ...
    public function simpanbahagian(Request $request)
    {
        ...
        foreach ($kumpulan->user_kumpulan as $ui) {
            ...
            $simpanbahagian->pegawai_sokong_id = $kumpulan->pegawai_sokong_id;
            $simpanbahagian->pegawai_lulus_id = $kumpulan->pegawai_lulus_id;
