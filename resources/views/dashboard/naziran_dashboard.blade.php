                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input id="rollcall_lokasi" class="form-control" name="lokasi"
                                                value="" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input id="rollcall_catatan" class="form-control" name="catatan"
                                                value="" disabled>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pegawai_sokong_id" class="lab">Pegawai Sokong</label>
                                        <div class="input-group input-group-merge">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pegawai_lulus_id" class="lab">Pegawai Lulus</label>
                                        <div class="input-group input-group-merge">
                ...
                eventClick: function(event, jsEvent, view) {
                    $.get(SITEURL + "/rollcalls/get_data/" + event.id, function(data, status) {
                        if (status == "success") {
                            ...
                            if (data.pegawai_sokong != null && data.pegawai_lulus != null) {
                                $('#rollcall_pegawai_sokong_id').val(data.pegawai_sokong.name);
                                $('#rollcall_pegawai_lulus_id').val(data.pegawai_lulus.name);
                            } else {
                                $('#rollcall_pegawai_sokong_id').hide();
                                $('#rollcall_pegawai_lulus_id').hide();
                                $('.lab').hide();
                            }
