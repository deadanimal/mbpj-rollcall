                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="text-red"> Tiada data</div>
                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                 ...
                                 <div class="modal fade " id="lihat{{$rollcall->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bg-default">
                                                <h2 class="text-white" > Makluman Kehadiran Penguatkuasa </h2>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                ...
                                <table id="example" class="display table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>No</th>
                                            <th>Tajuk Roll Call<br>Waktu Mula <br><br> Akhir rollcall</th>
                                            <th>Nama Penguatkuasa</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$pegawai_sokong_rollcall->siri_rollcall}} - {{$pegawai_sokong_rollcall->tajuk_rollcall}} <br><br>{{$pegawai_sokong_rollcall->mula_rollcall}} - {{$pegawai_sokong_rollcall->akhir_rollcall}}</td>
                                ...
                                <table id="example"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>No</th>
                                            <th>Tajuk Roll Call<br><br> Waktu Mula - Akhir rollcall</th>
                                            <th>Nama Penguatkuasa</th>
                                            <th>Waktu masuk <br><br> Waktu keluar</th>
                                            <th style="background-color:#00FF00" > Masuk / Keluar <br><br> eKedatangan</th>
                                            <th>Pegawai Sokong<br><br> Pegawai Lulus</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$pegawai_lulus_rollcall->siri_rollcall}} - {{$pegawai_lulus_rollcall->tajuk_rollcall}} <br><br>{{$pegawai_lulus_rollcall->mula_rollcall}}-{{$pegawai_lulus_rollcall->akhir_rollcall}}</td>
