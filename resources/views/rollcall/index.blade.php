                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$userrollcall->siri_rollcall}} - {{$userrollcall->tajuk_rollcall}}<br><br>
                                        ...
                                        <td> 
                                                <h5>  Tarikh  : <span style ="color:rgb(0, 17, 255)"> {{$userrollcall->tarikh}}</span> </h5>
                                                <h5>  Mula   : <span style ="color:rgb(0, 17, 255)"> {{$userrollcall->clockintime}}</span> </h5>
                                                <h5>  Akhir  : <span style ="color:rgb(0, 17, 255)"> {{$userrollcall->clockouttime}}</span> </h5>
                                                <h5>  Status  : <span style ="color:rgb(0, 17, 255)"> {{$userrollcall->statusdesc}}</span> </h5>
                                                <h5>  Waktu Anjal  :<span style ="color:rgb(0, 17, 255)"> {{$userrollcall->waktuanjal}}</span> </h5>            
                                        </td>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="semaksebab{{$userrollcall->userrollcall_id}}"  aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-default">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Sebab Tidak Hadir Roll Call</h5>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    <input class="form-control" value="{{$userrollcall->keterangan}}" disabled > <br>  
                                                        ...
                                                        <div class="col-md-12 text-center">
                                                            <div class="form-group">
                                                                ...
                                                                <a type="button" href="storage/{{$userrollcall->file_path}}"  target="_blank" class="btn btn-primary"> Muat Turun</a>
                                                                <br>                                                               
                                                            </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="sebabtakhadir{{$userrollcall->userrollcall_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="/simpan_sebab" enctype="multipart/form-data">
                                                        @csrf
                                                        
                                                        <div class="col-md-12 ">
                                                            <div class="form-group ">                                                               
                                                                    <input type="hidden"  value="{{$userrollcall->userrollcall_id}}" name="id">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 ">
                                                            <div class="form-group ">
                        ...
                        <div class="table-responsive py-4">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>{{$rollcall->siri_rollcall}} - {{$rollcall->tajuk_rollcall}}
                                        </td>
                                                        ...
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="card card-stats">
                                                                ...
                                                                <div class="card-body bg-default text-center">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <h5 class="card-title text-uppercase text-muted mb-0 text-white">HADIR
                                                                            </h5>
                                                                            <span class="h2 text-white font-weight-bold mb-0">{{$rollcall->jumlah_phadir}}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="card card-stats">
                                                                ...
                                                                <div class="card-body bg-default text-center ">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <h5 class="card-title text-uppercase text-muted mb-0 text-white">TIDAK HADIR
                                                                            </h5>
                                                                            <span class="h2 text-white font-weight-bold mb-0" >{{$rollcall->jumlah_ptidak_hadir}}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="card card-stats">
                                                                ...
                                                                <div class="card-body bg-default text-center">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <h5 class="card-title text-uppercase text-muted mb-0 text-white">JUMLAH
                                                                            </h5>
                                                                            <span class="h2 text-white font-weight-bold mb-0">{{$rollcall->jumlah_ptotal}}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="table-responsive py-4">
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$rollcall->siri_rollcall}} - {{$rollcall->tajuk_rollcall}}<br><br>  
                                                @if($rollcall->status =='dibuka')
                                            ...
                                            <td >
                                                ...
                                                data-target="#lihat{{$rollcall->id}}"><i class="ni ni-zoom-split-in"></i>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span class="badge badge-pill badge-default">Tiada Rekod</span>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a type="button" href="storage/{{$rollcallsbaru['file_path']}}" target="_blank" class="btn btn-sm btn-primary" >Muat Turun</a>
                    ...
                    <div class="card-body">
                            ...
                            <form>
                                <div class="row">
                                    <div class="col-sm mb-4">
                                        ...
                                        <select id="selected_rollcall" name="tajuk_rollcall" class="form-control">
                                            <option hidden selected> Tajuk Roll Call
                                            </option>
                                            @foreach ($rollcalls as $rollcallsfilter)
                                            <option value="{{$rollcallsfilter->siri_rollcall}} - {{$rollcallsfilter->tajuk_rollcall}}">
                                                {{$rollcallsfilter->siri_rollcall}} - {{$rollcallsfilter->tajuk_rollcall}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="row float-right">
                            <div class="col-sm ">
                                ...
                                <button onclick="customFilter()" class="btn btn-sm btn-primary " id="filter">Cari</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <form>
                                <div class="row">
                                    <div class="col-sm mb-4">
                                        <label for="tajuk_rollcall">Pilih Tajuk Roll Call</label>
                                        <select id="selected_rollcall2" name="tajuk_rollcall" class="form-control">
                                            <option hidden selected> Tajuk Roll Call
                                            </option>
                                            @foreach ($rollcalls as $rollcallsfilter2)
                                            <option value="{{$rollcallsfilter2->siri_rollcall}} - {{$rollcallsfilter2->tajuk_rollcall}}">
                                                {{$rollcallsfilter2->siri_rollcall}} - {{$rollcallsfilter2->tajuk_rollcall}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="row float-right">
                            <div class="col-sm ">
                                <a href="" class="btn btn-sm btn-danger">Hapus Cari</a>
                                <button onclick="customFilter2()" class="btn btn-sm btn-primary " id="filter">Cari</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row ">
                    <div class="col-md-12">
                        <div class="col-md-12 mb-4">
                            <button style="margin-bottom: 10px" class="btn btn-primary btn-sm sokong_all " data-url="{{ url('PegawaiSokongAll') }}">Sokong Pilihan</button>
                                ...
                                <table id="example" class="display table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$pegawai_sokong_rollcall->siri_rollcall}} - {{$pegawai_sokong_rollcall->tajuk_rollcall}} <br><br>{{$pegawai_sokong_rollcall->mula_rollcall}} <br><br> {{$pegawai_sokong_rollcall->akhir_rollcall}}</td>
                                            ...
                                            <td>
                                                    ...
                                                    <h5>  Tarikh  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_sokong_rollcall->tarikh}}</span> </h5>
                                                    <h5>  Mula   : <span style ="color:rgb(255, 0, 21)"> {{$pegawai_sokong_rollcall->clockintime}}</span> </h5>
                                                    <h5>  Akhir  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_sokong_rollcall->clockouttime}}</span> </h5>
                                                    {{-- <h5>  Jumlah OT  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_sokong_rollcall->totalworkinghour}}</span> </h5> --}}
                                                    <h5>  Status  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_sokong_rollcall->statusdesc}}</span> </h5>
                                                    {{-- <h5>  Jumlah Jam  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_sokong_rollcall->totalotduration}}</span> </h5> --}}
                                                    <h5>  Waktu Anjal  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_sokong_rollcall->waktuanjal}}</span> </h5>            
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group input-group-merge">
                                                                            <textarea class="form-control "
                                                                                name="sokong_sebab"
                                                                                placeholder="Sebab" type="text" rows="5" ></textarea>
                                                                        </div>
                                                                    </div>
                                                                <div class ="modal-footer">
                                                                <button type="button" class="btn btn-primary btn-sm "data-dismiss="modal">Tutup</button>
            ...
            <div class="container-fluid mt--6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <form>
                                <div class="row">
                                    <div class="col-sm mb-4">
                                        <label for="tajuk_rollcall">Pilih Tajuk Roll Call</label>
                                        <select id="selected_rollcall3" name="tajuk_rollcall" class="form-control">
                                            <option hidden selected> Tajuk Roll Call
                                            </option>
                                            @foreach ($rollcalls as $rollcallsfilter3)
                                            <option value="{{$rollcallsfilter3->siri_rollcall}} - {{$rollcallsfilter3->tajuk_rollcall}}">
                                                {{$rollcallsfilter3->siri_rollcall}} - {{$rollcallsfilter3->tajuk_rollcall}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="row float-right">
                            <div class="col-sm ">
                                <a href="" class="btn btn-sm btn-danger">Hapus Cari</a>
                                <button onclick="customFilter3()" class="btn btn-sm btn-primary " id="filter">Cari</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row ">
                    <div class="col-md-12">
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-primary btn-sm lulus_all " data-url="{{ url('PegawaiLulusAll') }}">Lulus Pilihan</button>
                            ...
                            <div class="table-responsive">
                                <table id="example"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" class="sub_chk" data-id="{{$pegawai_lulus_rollcall->id}}"></td>

                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$pegawai_lulus_rollcall->siri_rollcall}} - {{$pegawai_lulus_rollcall->tajuk_rollcall}} <br><br>{{$pegawai_lulus_rollcall->mula_rollcall}}<br><br>{{$pegawai_lulus_rollcall->akhir_rollcall}}</td>
                                            ...
                                            <td>
                                                ...
                                                <h5>  Tarikh  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_lulus_rollcall->tarikh}}</span> </h5>
                                                <h5>  Mula   : <span style ="color:rgb(255, 0, 21)"> {{$pegawai_lulus_rollcall->clockintime}}</span> </h5>
                                                <h5>  Akhir  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_lulus_rollcall->clockouttime}}</span> </h5>
                                                {{-- <h5>  Jumlah OT  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_lulus_rollcall->totalworkinghour}}</span> </h5> --}}
                                                <h5>  Status  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_lulus_rollcall->statusdesc}}</span> </h5>
                                                {{-- <h5>  Jumlah Jam  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_lulus_rollcall->totalotduration}}</span> </h5> --}}
                                                <h5>  Waktu Anjal  : <span style ="color:rgb(255, 0, 21)">{{$pegawai_lulus_rollcall->waktuanjal}}</span> </h5>            
                                            ...
                                            <td>
                                                @if($pegawai_lulus_rollcall->masuk !== null)
                                                   ...
                                                   @if($pegawai_lulus_rollcall)
                                                    ...
                                                    @if($pegawai_lulus_rollcall->sokong === null)
                                                     ...
                                                     @elseif($pegawai_lulus_rollcall->sokong === 1)
                                                        ...
                                                        @elseif($pegawai_lulus_rollcall->lulus === 0)
                                                            ...
                                                            <span class="badge badge-pill badge-success">Disahkan Pegawai Sokong</span><br><br>
                                                            <span class="badge badge-pill badge-danger">Ditolak Pegawai Lulus</span><br><br>
                                                            Sebab Tolak : {{$pegawai_lulus_rollcall->lulus_sebab}}
                                                    ...
                                                    <span class="badge badge-pill badge-danger">Ditolak Pegawai Sokong </span><br><br>
                                                    Sebab Tolak :{{$pegawai_lulus_rollcall->sokong_sebab}} <br><br>
                                        ...
                                        <div class="modal fade" id="tolak_lulus{{$pegawai_lulus_rollcall->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-default">
                                                        <h5 class="modal-title text-white" id="exampleModalLabel"> Tolak Kehadiran Roll Call Penguatkuasa ?
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
