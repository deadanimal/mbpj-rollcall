                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="/kumpulan">kumpulan</a></li>
                ...
                <div class="row ">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- Card body -->
                            <div class="card-body">
                                <form method="POST" action="/kumpulan/{{ $kumpulan->id }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input class="form-control" name="nama_kumpulan"
                                                        value="{{ $kumpulan->nama_kumpulan }}" type="text">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Pegawai Sokong </label>
                                                <div class="input-group input-group-merge">
                                                    <select class="form-control" name="pegawai_sokong">
                                                        <option disabled hidden selected>Sila Pilih</option>
                                                        @foreach ($pegawaiSokong as $p)
                                                            <option {{ $kumpulan->pegawai_sokong == $p->id }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Pegawai Lulus </label>
                                                <div class="input-group input-group-merge">
                                                    <select class="form-control" name="pegawai_lulus">
                                                        <option disabled hidden selected>Sila Pilih</option>
                                                        @foreach ($pegawaiLulus as $p)
                                                            <option {{ $kumpulan->pegawai_lulus == $p->id }}
                                                                value="{{ $p->id }}">{{ $p->name }}</option>
                                                        @endforeach
                                                    </select>
