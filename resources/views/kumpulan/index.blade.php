                                            ...
                                            @foreach ($kumpulan as $kumpulans)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <br>
                                                        <button onclick="buang({{ $kumpulans->id }})"
                                                            class="btn btn-danger btn-sm">Buang <i
                                                                class="ni ni-basket"></i></button><br><br>
                                                    </td>
                                                </tr>
                                        ...
                                        <tbody>
                                            @foreach ($kumpulan as $kumpulans)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $kumpulans->pegawaiSokong->name ?? 'Tiada' }}
                                                    </td>
                                                    <td>
                                                        {{ $kumpulans->pegawaiLulus->name ?? 'Tiada' }}
                                                    </td>
                                                    <td>
                                                        <a href="/kumpulan/{{ $kumpulans->id }}/edit"
                                                            class="btn btn-primary btn-sm"> kemaskini <i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (count($kump->user_kumpulan) > 0)
                                                            @foreach ($kump->user_kumpulan as $user)
                                                                <li>
                                                                    ...
                                                                    <button type="button" class="btn btn-sm btn-danger"
                                                                        data-toggle="modal"
                                                                        data-target="#hapus{{ $user->user_info->id }}">
                                                                        Tekan Untuk Hapus
                                                                    </button>

                                                                    <!-- Modal -->
                                                                    <div class="modal fade"
                                                                        id="hapus{{ $user->user_info->id }}"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <h4 class="text-red text-center">
                                                                                        {{ $user->user_info->name }}</h4>
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button"
                                                                                        class="btn btn-secondary btn-sm"
                                                                                        data-dismiss="modal">Tutup</button>
                                                                                    <a href="/delete_pengguna_kumpulan/{{ $user->user_info->id }}/{{ $kump->id }}"
                                                                                        class="btn btn-danger btn-sm">Tekan
                                                                                        Untuk Hapus</a>
                                                            ...
                                                            @endforeach
                                                        @else
                                                            <a href="/userkumpulan/create"
                                                                class="badge badge-pill badge-primary">Sila Tambah
                                                                Penguatkuasa</a>
                                                        @endif
                                                    </td>
                                                    {{-- @if (count($kump->user_kumpulan) > 0) --}}
