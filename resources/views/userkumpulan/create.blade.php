                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_kumpulan" class="form-control custom-select" required>
                                                ...
                                                @foreach ($kumpulan as $kumpulans)
                                                    <option value="{{ $kumpulans->id }}">{{ $kumpulans->nama_kumpulan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <h4 class="text-red">Tekan kekunci Ctrl (windows) atau Command (Mac) semasa
                                                memilih nama penguatkuasa untuk pilihan secara pukal.
                                            </h4>
                                            <select class="form-control mb-3 col-xl" style="height:50vh" name="id_user[]"
                                                id="id_user" multiple required>

                                                @foreach ($user as $users)
                                                    <option value="{{ $users->id }}">{{ $users->nric }} -
                                                        {{ $users->name }} -{{ $users->role }}</option>
                                                @endforeach
